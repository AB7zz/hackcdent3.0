    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start">
        ...
        <a href="" className="flex ml-2 md:mr-24">
          <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Axident</span>
        </a>
      </div>
      ...
      <li className="py-2">
        ...
        <li className="py-2">
            <a href="insurance" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">Apply for Insurance</span>
            </a>
         </li>
         <li className="py-2">
